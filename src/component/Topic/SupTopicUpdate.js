...
const fromun = {margin:'30px auto'};
 ...
 function SupTopicUpdate(){
    ...
    const { person1, topic, supervisor, supervisorOpinion } = oneTopic;
    ...
    function sendData(e){  
        ...
        axios.put('https://af-project-backend.azurewebsites.net/topic/up-sup-opinion/' + id, oneTopic).then(() => {
        ...
        <div>
            <form onSubmit={sendData}>
                ...
                <div style={fromun}>
                    ...
                    <select name="supervisorOpinion" value={supervisorOpinion} onChange={onInputChange} className="form-control">
